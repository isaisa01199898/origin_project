        ...
        while True:
            ...
            if left_pupil_x is not None and right_pupil_x is not None and left_pupil_y is not None and right_pupil_y is not None  :
                ...
                with open('line.csv', 'a', encoding='UTF-8') as f:
                        ...
                        writer.writerow([f'{left_pupil_x}',f'{left_pupil_y}', f'{right_pupil_x}',f'{right_pupil_y}',f'{text}',f'{right_pupil}',f'{left_pupil}', f'{time_now}'])
...
def heartrate():
    ...
    while True:
        ...
        try:
            ...
            print(f"{sensor_data}")
            with open('line.csv', 'r', encoding='ms932') as csv_file:
