...
def pitagorau(a,b):
    ...
    c2=numpy.sqrt(c2)
    return c2
def handan(r_x,r_y,l_x,l_y,sensor_data):
...
def data_get():
    global sensor_data,right_pupil_x,right_pupil_y,left_pupil_x,left_pupil_y
...
while True:
    left_pupil_x, left_pupil_y, right_pupil_x, right_pupil_y, sensor_data=data_get()

    handan(left_pupil_x, left_pupil_y, right_pupil_x, right_pupil_y, sensor_data)